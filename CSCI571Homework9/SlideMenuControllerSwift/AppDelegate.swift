...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    fileprivate func createMenuView() {
        ...
        let legViewController = storyboard.instantiateViewController(withIdentifier: "LegViewController") as! LegViewController
        let leftViewController = storyboard.instantiateViewController(withIdentifier: "LeftViewController") as! LeftViewController
        let nvc: UINavigationController = UINavigationController(rootViewController: legViewController)
        
        
        //UINavigationBar.appearance().tintColor = UIColor(hex: "689F38")
        
        leftViewController.legViewController = nvc
        
        
        let slideMenuController = ExSlideMenuController(mainViewController:nvc, leftMenuViewController: leftViewController)
        slideMenuController.automaticallyAdjustsScrollViewInsets = true
        slideMenuController.delegate = legViewController
